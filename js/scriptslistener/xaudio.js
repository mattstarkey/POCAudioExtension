...
Resampler.prototype.compileInterpolationFunction = function () {
	...
	//////// Matts Code to make the extension work.
	// this.interpolate = function (buffer) {
...
function XAudioServer(channels, sampleRate, minBufferSize, maxBufferSize, underRunCallback, defaultValue) {
	...
	XAudioJSSampleRate = (sampleRate > 0 && sampleRate <= 0xFFFFFF) ? sampleRate : 24000;
...
XAudioServer.prototype.checkFlashInit = function () {
	if (!this.flashInitialized && this.audioHandleFlash && this.audioHandleFlash.initialize) {
		...
		resetCallbackAPIAudioBuffer(24000, samplesPerCallback);
	}
...
var webAudioActualSampleRate = 24000;
var XAudioJSSampleRate = 24000; // greg - 0
var webAudioMono = true; // greg false
